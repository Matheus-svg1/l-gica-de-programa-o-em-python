...
def selecao_mudou(evento):
    ...
    if sel:
        ...
        label.config(text=f"{', '.join(itens)} selecionado (S) !") #join() entre cada um dos itens ele adiciona o que estiver entre chaves, exemplo: {", ".join(itens)} ele adicona uma virgula entre cada um dos elementos
    else:
